...
public class KafkaConsumerConfig {
        ...
        @Bean
        public ConsumerFactory<String, OrderFailed> consumerFactory() {
        ...
        @Bean
        public ConcurrentKafkaListenerContainerFactory<String, OrderFailed> kafkaListenerContainerFactory() {
                ConcurrentKafkaListenerContainerFactory<String, OrderFailed> factory = new ConcurrentKafkaListenerContainerFactory<>();
